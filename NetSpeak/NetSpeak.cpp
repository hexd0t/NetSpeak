...
const char* ts3plugin_name() {
	...
	if(!result) {
		result = (char*) NetSpeakManaged::TS3::Helper::UTF8(NetSpeakManaged::Plugin::PluginName).ToPointer();
	}
	return result;
}
...
const char* ts3plugin_version() {
	static char* result = NULL;  /* Static variable so it's allocated only once */
	if (!result) {
		result = (char*)NetSpeakManaged::TS3::Helper::UTF8(NetSpeakManaged::Plugin::PluginVersion).ToPointer();
	}
	return result;
}
...
const char* ts3plugin_author() {
	static char* result = NULL;  /* Static variable so it's allocated only once */
	if (!result) {
		result = (char*)NetSpeakManaged::TS3::Helper::UTF8(NetSpeakManaged::Plugin::PluginAuthor).ToPointer();
	}
	return result;
}
...
const char* ts3plugin_description() {
	static char* result = NULL;  /* Static variable so it's allocated only once */
	if (!result) {
		result = (char*)NetSpeakManaged::TS3::Helper::UTF8(NetSpeakManaged::Plugin::PluginDescription).ToPointer();
	}
	return result;
}
...
int ts3plugin_offersConfigure() {
	return (int)NetSpeakManaged::Plugin::OffersConfigure;
}
...
void ts3plugin_registerPluginID(const char* id) {
	...
	MP::Instance->PluginID = System::IntPtr((void*)&pluginID);
}
...
const char* ts3plugin_commandKeyword() {
	static char* result = NULL;  /* Static variable so it's allocated only once */
	if (!result) {
		result = (char*)NetSpeakManaged::TS3::Helper::UTF8(NetSpeakManaged::Plugin::PluginKeyword).ToPointer();
	}
	return result;
}
